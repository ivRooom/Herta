    ...
    <div className="space-y-6">
      <section className="rounded-3xl border border-primary/20 bg-surface p-6 shadow-card sm:p-8">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold tracking-tight sm:text-3xl">Community Leaderboard</h1>
            <p className="mt-2 max-w-2xl text-sm leading-6 text-muted">
              XP、Level、発言、Reaction、VC、Minecraft、Achievement、Season Pointをサーバーごとに比較できます。
            </p>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-muted">管理権限を持つDiscordサーバーを表示しています。</p>
          </div>
